...
| Deploy gap | **ZERO.** `DEPLOYED` reads `0167399` and so does HEAD, recorded by the script only after the installed copy verified. Derive this from `handoff_state.py`, never from here |
